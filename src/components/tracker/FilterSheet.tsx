...
export default function FilterSheet({
  ...
  selectedUsers, selectedCategories, onToggleUser, onToggleCategory, onClearAll,
}: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent
        side="bottom"
        className="p-0 rounded-t-3xl border-0"
        style={{ background: 'hsl(var(--background))' }}
      >
        <div className="mx-auto w-9 h-1 rounded-full bg-line mt-2 mb-3.5" />
        ...
        <div className="px-5 pb-3.5 pt-1.5 flex flex-wrap gap-2 max-h-[40dvh] overflow-y-auto">
        ...
        <div className="px-5 pt-3 pb-7 safe-bottom">
          <button
