...
9. Detect the bank or financial institution name that issued this statement. Look for it in headers, footers, account details, or logos (e.g. "HDFC Bank", "State Bank of India", "ICICI Bank", "Axis Bank", "Kotak Mahindra Bank", "Amex", "CITI"). Return it as "bank_name" on each transaction. Use a short, recognizable name (e.g. "HDFC Bank" not "HDFC Bank Limited"). If you cannot determine the bank, omit the field.
10. Return a raw JSON array only. No markdown fences, no explanation. Response must start with [ and end with ].`;
